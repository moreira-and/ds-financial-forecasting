...
from src.infrastructure.adapters.features.postprocessor_strategy import (
    BlankPostprocessor,
    IPostprocessorStrategy,
    DefaultRnnPostprocessor,
)
...
class DefaultRnnTransformStrategy(ITransformStrategy):
    def __init__(self, numeric_transformer=RobustScaler(), categorical_transformer=OneHotEncoder(sparse_output=False, handle_unknown="ignore")):
