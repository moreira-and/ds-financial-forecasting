...
from tensorflow.keras.layers import Input, Conv1D, LayerNormalization, Dropout, Bidirectional, LSTM, TimeDistributed, GRU, Dense, Add, Multiply, Lambda, Concatenate, Softmax, LeakyReLU
...
class RegressionMultiLayersModelBuilder(IModelBuilder):
    ...
    def build_model(self):
        ...
        rnn = Lambda(lambda x: K.sum(x, axis=1))(rnn)
