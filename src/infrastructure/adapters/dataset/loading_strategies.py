...
from src.infrastructure.config.settings import logger, CONFIG_DIR
from src.infrastructure.config.market_config_facade import MarketConfigFacade
...
class YfinanceLoadingStrategy(IDatasetLoadingStrategy):
    ...
    def _load_from_yfinance(self, interval: str = "1d") -> Dict[str, pd.DataFrame]:
        yf_data = {}
